...
#
Reference=$1;     # HV6.fa
Alignments=$2;    # hv6_aligned_sorted-heart.bam
Organ=$3;         # organ name
#
...
bcftools consensus -f $Reference calls.norm.flt-indels.vcf.gz > HV6-consensus-$Organ.fa
tail -n +2 HV6-consensus-$Organ.fa > TMP_FILE_X_KI.xki
echo "> $Organ HV6 consensus" > HV6-consensus-$Organ.fa
cat TMP_FILE_X_KI.xki >> HV6-consensus-$Organ.fa
#
# create bed file
zcat calls.norm.flt-indels.vcf.gz |vcf2bed --snvs > HV6-calls-$Organ.bed
#
