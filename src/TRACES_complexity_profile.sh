...
# ==============================================================================
# |                                                                            |
# |                 THIS PROGRAM COMPUTES COMPLEXITY PROFILES                  |
# |                 =========================================                  |
# |                                                                            |
# |            ./TRACES_complexity_profile.sh seq.fa level window              |
# |                                                                            |
# |                   PARAMETERS NEEDED TO THE COMPUTATION:                    |
# |                                                                            |
# |                    $1: FILE WITH THE GENOME IN FASTA                       |
# |                    $2: COMPRESION LEVEL, NUMBER [1;10];                    |
# |                    $3: WINDOW SIZE                                         |
# |                                                                            |
# ==============================================================================
#
...
if [[ "$RUN_COMPARISON" -eq "1" ]];
  ...
  #
  gto_filter -d 0 -w $WINDOW -c < SEQ_UB   > FIL_UB.x
  gto_filter -d 0 -w $WINDOW -c < SEQ_R_UB > FIL_UB_R.x
  #
  ...
  gnuplot << EOF
    ...
    set output "complexity-profile-$1.pdf"
