...
#
Reference=$1;     # HV1.fa
Alignments=$2;    # hv1_aligned_sorted-heart.bam
Organ=$3;         # organ name
#
...
bcftools consensus -f $Reference calls.norm.flt-indels.vcf.gz > HV1-consensus-$Organ.fa
tail -n +2 HV1-consensus-$Organ.fa > TMP_FILE_X_KI.xki
echo "> $Organ HV1 consensus" > HV1-consensus-$Organ.fa
cat TMP_FILE_X_KI.xki >> HV1-consensus-$Organ.fa
#
# create bed file
zcat calls.norm.flt-indels.vcf.gz |vcf2bed --snvs > HV1-calls-$Organ.bed
#
