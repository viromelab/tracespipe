...
#
Reference=$1;     # TTV.fa
Alignments=$2;    # ttv_aligned_sorted-heart.bam
Organ=$3;         # organ name
#
...
bcftools consensus -f $Reference calls.norm.flt-indels.vcf.gz > TTV-consensus-$Organ.fa
tail -n +2 TTV-consensus-$Organ.fa > TMP_FILE_X_KI.xki
echo "> $Organ TTV consensus" > TTV-consensus-$Organ.fa
cat TMP_FILE_X_KI.xki >> TTV-consensus-$Organ.fa
#
# create bed file
zcat calls.norm.flt-indels.vcf.gz |vcf2bed --snvs > TTV-calls-$Organ.bed
#
