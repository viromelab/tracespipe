...
# HISEQ
echo "Updating hiseq ...";
cp tracespipe/src/*.sh hiseq/tracespipe/src/
echo "Done!";
# 
# NOVASE 1
for name in "${INDIVIDUALS1[@]}" #
  do
  echo "Updating: $name ...";
  cp tracespipe/src/*.sh novaseq_1/$name/tracespipe_template/src/
  echo "Done!";
  done
#
# NOVASE 2
for name in "${INDIVIDUALS2[@]}" #
  do
  echo "Updating: $name ...";
  cp tracespipe/src/*.sh novaseq_2/$name/tracespipe_template/src/
  echo "Done!";
  done
#
