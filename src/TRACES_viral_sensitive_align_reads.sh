#!/bin/bash
# 
# EXTREME SENSITIVE ALIGNMENT OF VIRAL READS
#
...
#
# ALIGN
bowtie2 -a --very-sensitive --threads $4 -x index-$2-$3-file -1 o_fw_pr.fq -2 o_rv_pr.fq -U o_fw_unpr.fq,o_rv_unpr.fq > aligned-$2-$3.sam
#
# SORT & BIN
