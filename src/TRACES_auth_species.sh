...
for read in "${READS[@]}" #
  ...
  FALCON -c 30 -l 47 -t 200 -x $OUTPUT/MT-SPECIES-$ORGAN.txt -n $THREADS reads_human_auth.fq SPECIES-MTs.fa 1>> ../logs/Log-stdout-$ORGAN.txt 2>> ../logs/Log-stderr-$ORGAN.txt;
  done
#
# ==============================================================================
#
