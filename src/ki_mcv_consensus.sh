...
#
Reference=$1;     # MCV.fa
Alignments=$2;    # mcv_aligned_sorted-heart.bam
Organ=$3;         # organ name
#
...
bcftools consensus -f $Reference calls.norm.flt-indels.vcf.gz > MCV-consensus-$Organ.fa
tail -n +2 MCV-consensus-$Organ.fa > TMP_FILE_X_KI.xki
echo "> $Organ MCV consensus" > MCV-consensus-$Organ.fa
cat TMP_FILE_X_KI.xki >> MCV-consensus-$Organ.fa
#
# create bed file
zcat calls.norm.flt-indels.vcf.gz |vcf2bed --snvs > MCV-calls-$Organ.bed
#
