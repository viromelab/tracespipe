...
CHECK_ADAPTERS_AR;
#
rm -f $GID.fa* $GID-$ORGAN.sam $GID-$ORGAN.bam FIL-$GID-$ORGAN.bam 
...
rm -fr ../output_data/TRACES_damage_$GID-$ORGAN
mapDamage --rescale -d ../output_data/TRACES_damage_$GID-$ORGAN -i FIL-$GID-$ORGAN.bam -r $GID.fa 1>> ../logs/Log-stdout-$ORGAN.txt 2>> ../logs/Log-stderr-$ORGAN.txt;
