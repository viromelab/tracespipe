...
#
Reference=$1;     # HV5.fa
Alignments=$2;    # hv5_aligned_sorted-heart.bam
Organ=$3;         # organ name
#
...
bcftools consensus -f $Reference calls.norm.flt-indels.vcf.gz > HV5-consensus-$Organ.fa
tail -n +2 HV5-consensus-$Organ.fa > TMP_FILE_X_KI.xki
echo "> $Organ HV5 consensus" > HV5-consensus-$Organ.fa
cat TMP_FILE_X_KI.xki >> HV5-consensus-$Organ.fa
#
# create bed file
zcat calls.norm.flt-indels.vcf.gz |vcf2bed --snvs > HV5-calls-$Organ.bed
#
