...
FALCON -v -n 12 -t $TOP_SIZE -F -Z -m 6:1:1:0/0 -m 11:50:1:0/0 -m 18:500:1:5/10 -g 0.85 -c 70 -x top-non-viral-$ORGAN.csv -y $ORGAN.com $RNAMES $DB
...
head -n 40 F-top-non-viral-$ORGAN.csv | awk '{ if($3 > 1) print $1"\t"$2"\t"$3"\t"$4; }' \
