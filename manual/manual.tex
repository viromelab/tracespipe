...
%
\begin{figure}[h!]
\centerline{\includegraphics[width=9cm]{../imgs/logo.png}}
\label{logo}
\end{figure}
~\\
\textbf{A pipeline for reconstruction and analysis of viral\\ and human-host genomes at multi-organ level}
~\\~\\
\large
D. Pratas$^{1,2,3}$ (pratas@ua.pt)\\
~\\~\\
\small
$^1$ IEETA, University of Aveiro, Portugal\\
$^2$ DETI, University of Aveiro, Portugal\\
$^3$ DV, University of Helsinki, Finland\\
~\\
Version 1.1
}
\date{}
